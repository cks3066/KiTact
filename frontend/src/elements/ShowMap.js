...
const Rect = (props) => (
  <Marker
    position={new window.naver.maps.LatLng(37.2380651, 131.8562652)}
    animation={0}
    onClick={() => {
      alert("마커 클릭");
    }}
...
class ShowMap extends React.Component {
  constructor(props) {
    ...
    this.dokdo = new window.naver.maps.LatLngBounds(
      new window.naver.maps.LatLng(37.2380651, 131.8562652),
      new window.naver.maps.LatLng(37.2444436, 131.8786475)
    );
  }
  ...
  render() {
    return (
      <NaverMap
        ...
        defaultCenter={new window.naver.maps.LatLng(37.5666805, 126.9784147)}
        defaultZoom={5}
